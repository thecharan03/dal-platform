/* =========================================================
   DAL DRIVER — LIVE LOGISTICS NAVIGATION ENGINE
   ========================================================= */
...
async function loadDriverData() {
    ...
    /*
       FIRST STEP:
       Ask/select the driver.

       Driver can be supplied through:
       ?driver_id=REAL_DRIVER_ID

       or:

       localStorage DAL_DRIVER_ID
    */
    ...
    */
    ...
    /*
       Shipment assigned to driver's vehicle.
    */
...
function findRequestedDriver(
    ...
    /*
       ...
       The driver must be selected first.
    */
...
function renderDriverSelector(
    ...
    if (!drivers.length) {
        ...
        renderNoAssignment(
            "No drivers are registered in DAL."
        );
    ...
    routeList.innerHTML = `
        <div class="driver-selector">
            ...
            <div style="
                ...
                margin-bottom:14px;
            ">
                Choose your driver to load the
                linked vehicle and shipment.
            </div>
...
function renderDriver() {
    ...
    /*
       Existing UI may not have a dedicated
       driver-name element.
    ...
    */
    ...
    /*
       Keep avatar working with existing UI.
    */
...
function renderVehicle() {
    ...
    */
    ...
    /*
       Also support alternative IDs if the HTML
...
function renderShipment() {
    ...
    /*
       If shipment has readable place names,
       use them first.
